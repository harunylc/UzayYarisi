...
public class QTETest_P2_Zor : MonoBehaviour
{
    [Header("QTE Buttons")]
    ...
    private void SpawnMeteor()
    {
        ...
        MeteorFollow2_Zor mf = meteor.GetComponent<MeteorFollow2_Zor>() ?? meteor.AddComponent<MeteorFollow2_Zor>();
        mf.target = player;
...
public class MeteorFollow2_Zor : MonoBehaviour
{
