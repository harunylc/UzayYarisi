...
public class QTETest_Orta : MonoBehaviour
{
    [Header("QTE Buttons")]
    ...
    private void SpawnMeteor()
    {
        ...
        MeteorFollow_Orta mf = meteor.GetComponent<MeteorFollow_Orta>() ?? meteor.AddComponent<MeteorFollow_Orta>();
        mf.target = player;
...
public class MeteorFollow_Orta : MonoBehaviour
{
