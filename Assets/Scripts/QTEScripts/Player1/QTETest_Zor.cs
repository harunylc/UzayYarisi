...
public class QTETest_Zor : MonoBehaviour
{
    [Header("QTE Buttons")]
    ...
    private void SpawnMeteor()
    {
        ...
        MeteorFollow_Zor mf = meteor.GetComponent<MeteorFollow_Zor>() ?? meteor.AddComponent<MeteorFollow_Zor>();
        mf.target = player;
...
public class MeteorFollow_Zor : MonoBehaviour
{
