...
public class QTETest_P2_Orta : MonoBehaviour
{
    [Header("QTE Buttons")]
    ...
    private void SpawnMeteor()
    {
        ...
        MeteorFollow2_Orta mf = meteor.GetComponent<MeteorFollow2_Orta>() ?? meteor.AddComponent<MeteorFollow2_Orta>();
        mf.target = player;
...
public class MeteorFollow2_Orta : MonoBehaviour
{
